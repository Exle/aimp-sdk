...
// -----------------------------------------------------------------------------
  ...
  AIMP_MSG_CMD_BASE = 0;
  // Param1: Command ID (see AIMP_MSG_CMD_XXX)
  ...
  // Param1: Active tab sheet index [0..5]
  // Param2: unused
  ...
  AIMP_MSG_CMD_BRING_TO_TOP = AIMP_MSG_CMD_BASE + 62; // v6.0
...
// -----------------------------------------------------------------------------
  ...
  // Param1: AIMP_MSG_PROPVALUE_GET / AIMP_MSG_PROPVALUE_SET
  // Param2: Pointer to LongBool (32-bit boolean value) variable
  AIMP_MSG_PROPERTY_JUMP_TO_NEXT_TRACK = AIMP_MSG_PROPERTY_BASE + 38;

  // State of "the "previous track" action jumps to track beginning" option
  // Param1: AIMP_MSG_PROPVALUE_GET / AIMP_MSG_PROPVALUE_SET
  // Param2: Pointer to LongBool (32-bit boolean value) variable
  AIMP_MSG_PROPERTY_JUMP_TO_BEGINNING_ON_PREV_TRACK = AIMP_MSG_PROPERTY_BASE + 39;
...
// -----------------------------------------------------------------------------
  ...
  AIMP_MSG_EVENT_STREAM_END = AIMP_MSG_EVENT_BASE + 5;
    // Param1 contains combination of following flags:
  ...
  // Param2: FileName (Pointer to Char)
  ...
  // Param2: FileName (Pointer to Char)
  // !!!Note: If filename is empty or Param2 is nil - statistics for all files has been changed
  // !!!WARNING: You must not fire this event manually!
  ...
  // Called every second by timer unlike the
  // AIMP_MSG_EVENT_PROPERTY_VALUE event for AIMP_MSG_PROPERTY_PLAYER_POSITION property
  ...
  // Param1: Unused
  // Param2: Pointer to char-array, can be = nil (ReadOnly!)
